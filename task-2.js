...
/* 
    ...
    закупки нужных вещей,
    что и было поручено Савельичу. Я остановился в трактире. 
   ...
   итоговый текст должен быть собран из массива array и результат записать 
   в переменную result
*/
const array = [
'я в Симбирск,',
...
*/
 const myData = (firstName, lastName) => {
    const fullName = `${firstName} ${lastName}`
       console.log(fullName);
};
myData("Sergey", "Sergeev");
